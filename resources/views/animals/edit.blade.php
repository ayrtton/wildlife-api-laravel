                        ...
                        <form action="{{ route('animals.update', $animal->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div>
                                ...
                                <input type="text" name="specie" class="form-control" id="specie"
                                    aria-describedby="specie" value="{{ $animal->specie }}" />
                                @error('specie')
                            ...
                            <div class="mt-4">
                                ...
                                <input type="text" name="scientific_name" class="form-control" id="scientific_name"
                                    aria-describedby="scientific_name" value="{{ $animal->scientific_name }}" />
                            ...
                            <div class="mt-4">
                                ...
                                <input type="url" name="image_url" class="form-control" id="image_url"
                                    aria-describedby="image_url" value="{{ $animal->image_url }}" />
                                @error('image_url')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="mt-4">
                                ...
                                <textarea name="description" class="form-control" id="description" aria-describedby="description"
                                    rows="9">{{ $animal->description }}</textarea>
                                @error('description')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="mt-4">
                                ...
                                <select name="animal_class_id" id="animal_class">
                                    ...
                                    @foreach ($animalClasses as $animalClass)
                                        @if ($animal->animalClass()->first() == $animalClass)
                                            <option value="{{ $animalClass->id }}" selected>
                                                {{ $animalClass->title }}</option>
                                        @else
                                            <option value="{{ $animalClass->id }}">{{ $animalClass->title }}
                                            </option>
                                        @endif
                                    @endforeach
                                </select>
                            ...
                            <div class="mt-4">
                                ...
                                <textarea name="references" class="form-control" id="references" aria-describedby="references"
                                    rows="3">{{ $animal->references }}</textarea>
                                @error('references')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
